{
  inputs = {
    ...
    prelude-typescript = {
      url = "github:mlabs-haskell/prelude-typescript/v1.0.3";
      inputs = {
      ...
      perSystem =
        ...
        in
        {
          packages = {
            ...
            # Documentation
            docs = tsFlake.packages.plutus-ledger-api-typescript.overrideAttrs (
              _self:
              (_super: {
                name = "docs";
                npmBuildScript = "docs";
          ...
          devShells = {
            default = tsFlake.devShells.plutus-ledger-api-typescript;
            update = tsFlake.devShells.plutus-ledger-api-typescript-update;
          };
